#!/usr/bin/env python
#
# How to submit gaia-ui power test results to Datazilla:
# 1) Attach a b2g device with an engineering build
# 2) Issue 'adb forward tcp:2828 tcp:2828' cmd
# 3) Run a gaia-ui power test, resulting in a checkpoint_*_summary.log results file
...
#                        checkpoint_summary[k] = v
        ...
        results[checkpoint_summary['test_name']] = checkpoint_summary['average']
